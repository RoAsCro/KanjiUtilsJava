    ...
    <div class="container" style="flex-direction: column; flex-wrap: nowrap;">
        <div class="container">
            <p class="prominentWord" id="wordLanding"
                <c:if test='${hideWord}'>style="display: none;"></c:if>>Loading...</p>
        </div>
        <p class="prominentWord" style="font-size: 5vh; <c:if test='${hideEnglish}'>display: none;</c:if>" id="englishLanding">Loading...</p>
